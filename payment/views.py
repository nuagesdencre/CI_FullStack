    ...
    if request.method == "POST":
        ...
        if order_form.is_valid() and payment_form.is_valid():
            ...
            if customer.paid:
                ...
                messages.error(request, "We were unable to process your payment.")
        else:
            print(payment_form.errors)
            messages.error(request, "We were unable to process your payment with the card details provided.")
    else:
